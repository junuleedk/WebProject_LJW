...
public class EventWriteController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        session.setAttribute("type", "qna");
        
		request.getRequestDispatcher("eventpage/EventWrite.jsp").forward(request, response);
	}
...
//		}
		...
		if(result == 1) { //글쓰기 성공
			...
			JSFunction.alertLocation(response, "글쓰기에 실패했습니다.", "./eventwrite.do");
		}
	}
}
