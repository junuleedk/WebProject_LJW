...
public class CourseEditController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		request.getRequestDispatcher("coursepage/CourseEdit.jsp").forward(request, response);
	}
...
//			response.sendRedirect("./course.do?idx=" + idx);
			JSFunction.alertLocation(response, "게시글이 성공적으로 수정되었습니다.", "course.do");
		}
		else {
			System.out.println("실패");
			JSFunction.alertLocation(response, "게시글 수정에 실패하였습니다.", "courseedit.do");
