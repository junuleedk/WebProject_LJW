		...
		<div class="container">
			...
			<table class="board_table">
				...
				<tr>
					...
					<c:if test="${ dto.id eq userId}" var="result">
						<button type="button" class="btn_course"
							onclick="location.href='./courseedit.do?mode=edit&idx=${ param.idx}';">
							수정하기</button>
						<button type="button" class="btn_course"
							onclick="location.href='./coursedelete.do?mode=delete&idx=${ param.idx}';">
							삭제하기</button>
						<button type="button" class="btn_course"
							onclick="location.href='./course.do';">목록 바로가기</button>
					</c:if>
					<c:if test="${ not result }">
						<button type="button" class="btn_course"
							onclick="location.href='./course.do';">목록 바로가기</button>
