		...
		<div class="container">
			...
			<div class="course_container">
				<div class="course_content">
					<div class="box">
						<img src="images/c-1.jpg" alt="" /> <a href="" class=""> <img
					...
					<div class="box">
						<img src="images/c-2.jpg" alt="" /> <a href="" class=""> <img
							src="images/link.png" alt="" />
						</a>
						<h5>
							From <br /> Zero to Hero
						</h5>
					</div>
				</div>
				...
				<section class=board_course">
					<div class="container">
						<div class="heading_container">
							<h3>COURSE BOARD</h3>
							<p>You can freely write about COURSE on this board.</p>
							<!-- 검색 폼 -->
							<div class="search-form">
								<form method="get" action="./course.do">
							...
							<div class="button-container">
								<td width="100">
									<button type="button"
										onclick="location.href='./coursewrite.do';" class="btn_course">글쓰기</button>
								</td>
							</div>
						</div>
											...
											<c:forEach items="${ boardLists }" var="row" varStatus="loop">
												<c:if test="${row.type == 'free' }">
													<tr align="center">
														...
														<td align="left"><a
															href="./courseview.do?idx=${ row.idx }"> ${ row.title }
														</a></td>
														<td>${ row.id }</td>
														<td>${ row.postdate }</td>
				...
				<div class="course_content">
					<div class="box">
						<img src="images/c-3.jpg" alt="" /> <a href="" class=""> <img
							src="images/link.png" alt="" />
						</a>
						<h5>
							Learn <br /> Python – Interactive
						</h5>
					</div>
					<div class="box">
						<img src="images/c-4.jpg" alt="" /> <a href="" class=""> <img
							src="images/link.png" alt="" />
						</a>
						<h5>
							Your <br /> Complete Guide
						</h5>
					</div>
					<div class="box">
						<img src="images/c-5.jpg" alt="" /> <a href="" class=""> <img
							src="images/link.png" alt="" />
						</a>
						<h5>Photography</h5>
					</div>
